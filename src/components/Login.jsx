...
const Login = () => {
  ...
  const ModeSwitch = ({ mode, children }) => {
    ...
    return (
      <div style={{ marginTop: '30px' }}>
        <span style={{ color: '#fff', opacity: 0.8 }}>{children}</span>
        <Typography
          color='primary'
  ...
  return (
    <div className={classes.centerAlign}>
      ...
      <img className='expense-image' src={expense} alt="expense"/>
        <TextField
          id={showSignup ? 'Name' : ' '}
        ...
        {showSignup ? (
          ...
          <>
            ...
            <ModeSwitch className="signup" mode='Sign up'>No account?</ModeSwitch>
          </>
        )}
      </form>
    </div>
